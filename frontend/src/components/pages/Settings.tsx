...
const Settings: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Also update localStorage for client-side services that might read it directly
        ...
        <div>
            ...
            <form onSubmit={handleSubmit} className="max-w-3xl mx-auto space-y-8 bg-white p-8 rounded-lg shadow-md border-t-4 border-primary-600">
                ...
                <div className="flex justify-end items-center space-x-4 pt-6 border-t">
                    ...
                    <Button type="submit" className="px-6 py-2.5 text-base shadow-lg shadow-primary-500/30" isLoading={isSaving}>Guardar Cambios</Button>
                </div>
            </form>
        </div>
    );
